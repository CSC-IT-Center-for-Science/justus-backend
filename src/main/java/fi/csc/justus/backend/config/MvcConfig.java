...
//import fi.csc.justus.backend.spring.resolver.OIDArgumentResolver;
...
public class MvcConfig extends WebMvcConfigurerAdapter {
    ...
    /**
     * SpringFox (swagger) can resolve the real return types from
     * HttpEntitys but to go inside CompletableFuture there's a need
     * to define alternate type rules.
     *
